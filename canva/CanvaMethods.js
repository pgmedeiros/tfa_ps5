        ...
        self.points.forEach(point => {
            ...
            if (point.current_x > (p5.width * get_inverse_of_scale(self.scaleFactor))/2) {
                self.sub.forEach(sub_obj => {
                    sub_obj.points.push(new Point(-250 * get_inverse_of_scale(sub_obj.scaleFactor), point.current_y - self.translate_y,point.img_x - self.translate_x, point.img_y - self.translate_y, point.img_x - self.translate_x));
                })
